...
class CineRepository implements IRepository
{
    ...
    private $connection;
    private $tableName="       ";//agregar nombre de la tabla
    ...
    public function add(Cine $cine)
    {
       try {
           ...
           $query = "INSERT INTO ".$this->tableName." (name, address, capacity,ticket_value,active) VALUES (:cinema_name,:address,:capacity,:ticket_value,:active);";
    ...
    public function modifyCine($cine){
        ...
        try {
            ...
            $query = "UPDATE ". $this->tableName . "SET name=:name, adress=:adress, capacity=:capacity, ticket_value=:ticket_value, active=:active"; 
