	...
	<div class="container" id="container">
		<div class="form-container sign-up-container">
			<form class="login-form" action=<?= FRONT_ROOT . "/User/createUser" ?> method="POST" class="login-form">
				...
				<input class="input-login" name="SignupDNI" type="text" placeholder="D.N.I" pattern="[0-9]{7,}" title="Solo se permiten numeros(minimo 8), sin espacios ni guiones" required>
